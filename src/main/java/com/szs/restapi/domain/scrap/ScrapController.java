...
import com.szs.restapi.domain.refund.RefundDTO;
...
public class ScrapController {
    ...
    public ResponseEntity<?> executeScrap (@RequestHeader("Authorization") String accessToken, @AuthenticationPrincipal SzsUserDetails userDetails) throws Exception {
        return ResponseEntity.ok(scrapService.execute(accessToken, userDetails));
    }
